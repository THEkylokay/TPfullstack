...
mvn archetype:generate -B "-DgroupId=fr.insa.acid" "-DartifactId=exercice4" "-DarchetypeArtifactId=maven-archetype-quickstart" "-DarchetypeVersion=1.5" "-DinteractiveMode=false"
